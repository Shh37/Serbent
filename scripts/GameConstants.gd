...
const COLOR_RANKING_LENGTH = COLOR_SNAKE
const COLOR_RANKING_LENGTH_HOVER = Color("#b8c47a")
const COLOR_RANKING_LENGTH_PRESSED = Color("#7f8b4d")
const COLOR_RANKING_SURVIVAL = COLOR_ACCENT_BLUE
const COLOR_RANKING_SURVIVAL_HOVER = Color("#8ec7ba")
const COLOR_RANKING_SURVIVAL_PRESSED = Color("#4f7771")
...
const SNAKE_SPEED_INCREMENT = 0.0027
